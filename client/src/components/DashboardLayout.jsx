    ...
    <section className="">
      <div className="flex py-3 px-3 justify-between items-center gap-y-5  my-3 text-lg bg-slate-900 rounded-lg border border-slate-600">
        <span className="space-x-1 md:space-x-3 text-sm md:text-base">
          <NavLink
            to={"/dashboard"}
            className={`hover:bg-slate-700 transition-all duration-300 px-3 py-1 rounded-full ${
              location.pathname === "/dashboard" && "bg-slate-600"
            }`}
          >
            الملف الشخصي
          </NavLink>
          {user.role === "admin" ? (
            <>
              <Link
                ...
                className={`hover:bg-slate-700 transition-all duration-300 px-3 py-1 rounded-full ${
                  location.pathname.includes("create") && "bg-slate-600"
                }`}
              >
                اضافة كويز
              </Link>
              <Link
                to={"/dashboard/quizes"}
                className={`hover:bg-slate-700 transition-all duration-300 px-3 py-1 rounded-full ${
                  location.pathname.includes("quizes") && "bg-slate-600"
                }`}
              >
                الكويز
              </Link>
            ...
            <>
              <Link
                ...
                className={`hover:bg-slate-700 transition-all duration-300 px-3 py-1 rounded-full ${
                  location.pathname.includes("history") && "bg-slate-600"
                }`}
              >
                السجل
              </Link>
